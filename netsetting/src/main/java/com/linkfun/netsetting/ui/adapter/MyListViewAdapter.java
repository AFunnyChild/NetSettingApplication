package com.linkfun.netsetting.ui.adapter;
...
public class MyListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            tag.ivConnectState = (ImageView) convertView
                    .findViewById(R.id.iv_wifi_connect_state);
            tag.ivLock = (ImageView) convertView
        ...
        if (desc.equals("已连接")){
            holder.ivConnectState.setVisibility(View.VISIBLE);
        }else{
            holder.ivConnectState.setVisibility(View.GONE);
        }
